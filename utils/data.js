...
export const ThematicAreas = [
  {
    image: "/HomePage/ThematicAreas/img-1.png", // Replace with your image path
    title: "Health & Wellbeing",
    description:
      "Empowering the workforce through informed choices and inclusive care",
  },
  {
    image: "/HomePage/ThematicAreas/img-2.png", // Replace with your image path
    title: "Gender Equality, Inclusion & Diversity",
    description:
      "Creating spaces where everyone feels safe, valued, and included",
  },
  {
    image: "/HomePage/ThematicAreas/img-3.png", // Replace with your image path
    title: "Agency Building for Women & Young Girls",
    description: "Strengthening voices, shaping futures for women and girls",
  },
  {
    image: "/HomePage/ThematicAreas/img-4.png", // Replace with your image path
    title: "Financial & Digital Inclusion",
    description: "Bridging gaps with financial know-how",
  },
  {
    image: "/HomePage/ThematicAreas/img-5.png", // Replace with your image path
    title: "Workplace/ Social Dialogues",
    description: "Fostering open dialogue for empowered workplaces",
  },
  {
    image: "/HomePage/ThematicAreas/img-6.png", // Replace with your image path
    title: "Social Protection",
    description: "Strengthening safety nets for every workforce",
  },
];
...
export const modalContent = {
  ...
  sections: [
    {
      ...
      title: "Nutrition, Sanitation & Personal Hygiene: bjSVgjvZgjcvZKVc",
      description:
        "We believe that everyday habits play a crucial role in maintaining good health. Through education and resources, we empower the workforce to make informed choices about nutrition, sanitation, and personal hygiene, promoting overall wellness in the workplace.",
    },
  ...
  sections: [
    {
      icon: "/HomePage/ThematicAreas/Popup/img-1.svg",
      title: "Nutrition, Sanitation & Personal Hygiene: test bhahavn",
      description:
        "We believe that everyday habits play a crucial role in maintaining good health. Through education and resources, we empower the workforce to make informed choices about nutrition, sanitation, and personal hygiene, promoting overall wellness in the workplace.",
    },
    {
...
export const StrengtheningData = [
  ...
  },
  {
    ...
    description: `
      Implementing effective transformative policies and programmes has demonstrated measurable outcomes. The study by Tuft University indicates that increasing women’s earnings to 91 cents for every dollar earned by men, thereby contributing to a more equitable workplace. Study by Gartner has shown that inclusive teams <a href="" target="_blank" class="text-blue-500 underline">improve team performance by up to 30 percent</a> in high-diversity environments.
    `,
    description2: `“Furthermore, the SDGs promote <a href="" class="text-blue-500 underline">decent work and economic growth</a> by seeking full and productive employment and decent work for all women and men including for young people and persons with disabilities, and equal pay for work of equal value. Mainstreaming of a gender perspective is crucial in the implementation of the <a href="" class="text-blue-500 underline">2030 Agenda for Sustainable Development</a>” ~ UN`,
